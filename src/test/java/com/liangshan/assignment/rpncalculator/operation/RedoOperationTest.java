 ...
 * @author lianshan
 */
public class RedoOperationTest {

    @InjectMocks
    private RedoOperation operation = new RedoOperation();
    ...
    public void testOperate() {
        ...
        when(redoBuffer.redo()).thenReturn(null);
        operation.operate();
        Assert.assertEquals(0, calculator.getNumbers().size());
        Stack<String> stack = new Stack<>();
        stack.push("1");
        stack.push("2");
        when(redoBuffer.redo()).thenReturn(stack);
        operation.operate();
